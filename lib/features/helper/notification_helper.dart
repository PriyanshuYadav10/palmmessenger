...
//     var androidInitialize =  const AndroidInitializationSettings('notification_logo');
...
//       try{
//         if(message.notification?.titleLocKey != null && message.notification?.titleLocKey?.isNotEmpty==true) {
//           //MyApp.navigatorKey.currentState.push(MaterialPageRoute(builder: (context) => OrderDetailsScreen(orderModel: null, orderId: int.parse(message.notification.titleLocKey))));
//         }
//       }catch (e) {}
//     });
//   }
...
//         _image = (message.notification?.android?.imageUrl != null && message.notification?.android?.imageUrl?.isNotEmpty==true)
//             ? message.notification?.android?.imageUrl?.startsWith('http')==true ? message.notification?.android?.imageUrl
//             : '${AppConstants.baseURL}/storage/app/public/notification/${message.notification?.android?.imageUrl}' : null;
//       }else if(Platform.isIOS) {
//         _image = (message.notification?.apple?.imageUrl != null && message.notification?.apple?.imageUrl?.isNotEmpty==true)
//             ? message.notification?.apple?.imageUrl?.startsWith('http')==true ? message.notification?.apple?.imageUrl
